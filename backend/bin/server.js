...
app.get('/api/v3/creator/videos/:publicKey', async (req, res) => await iowrapper('getVideoByCreators', req, res))

app.get('/api/v3/creator/recommendations/:publicKey', async (req, res) => await iowrapper('youChooseByProfile', req, res))
